  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.textContainer}>
        <Image
          style={styles.image}
          source={require("../../../assets/estressado.png")}
        />
        <Text style={styles.description}>
        Sente-se confortavelmente e feche os olhos. Respire profundamente e solte o ar devagar.
        Imagine o estresse como uma nuvem que se dissipa. Diga para si mesmo: “Estou relaxado.”
        Sinta a tensão se aliviar e abra os olhos quando estiver pronto.
        </Text>
      </View>
        ...
        style={styles.video}
        source={require("../../../assets/estressado.mp4")} // Vídeo local usando require
